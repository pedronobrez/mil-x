...
# (SCIEX_LICENSE.txt). They are NOT in this repository, and they are not in any OpenDIAL release:
# reading that licence is the user's to do, not ours to do for them.
#
#   .\scripts\fetch-sciex-assemblies.ps1                     -> opendial\vendor\sciex   (building from source)
#   .\scripts\fetch-sciex-assemblies.ps1 -Dest "C:\Program Files\OpenDIAL\plugins\sciex"
#                                                            -> an installed application
#   .\scripts\fetch-sciex-assemblies.ps1 -From D:\sdk         -> copy from a folder you already have
#
# An installed OpenDIAL reads .wiff natively as soon as these files are in its plugins\sciex
