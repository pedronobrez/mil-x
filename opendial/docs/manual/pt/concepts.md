...
A aplicação usa um vocabulário pequeno e fixo. A maior parte é do MS-DIAL; onde o OpenDIAL tem uma
...
O MS-DIAL escreve a confiança de uma anotação no próprio nome, e o OpenDIAL lê-a de volta como a
...
o resto vai para um arquivo lateral (*sidecar*) do OpenDIAL, ou — no caso dos picos — de volta ao
próprio resultado do alinhamento. Veja [[projects-and-files]].

## Projetos e resultados

Um **projeto OpenDIAL** (`.odproj`) é um pequeno arquivo JSON: o lote, o texto do método, a pasta
...
- O cache de varreduras de survey e o arquivo de projeto OpenDIAL.
