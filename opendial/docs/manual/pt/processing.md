...
lado do arquivo de projeto, ou `opendial_results` ao lado do primeiro arquivo bruto num lote sem
projeto.
...
| --- | --- |
| **Setup** | a pasta de saída é criada; o método é gravado nela como `opendial_method.txt`; o passo de correção de tempo de retenção é preparado |
...
| **Done** | o resultado é carregado em Analytics e Statistics, e o projeto OpenDIAL é salvo se tiver um caminho |
