...
`opendial_method.txt` no início de toda corrida, que é como um resultado registra como foi feito.
...
grava-o de volta. Abrir uma pasta de resultados sem projeto lê `opendial_method.txt` dela quando
