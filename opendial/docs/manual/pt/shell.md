...
O título diz `OpenDIAL — <nome do projeto>`, com um `•` depois enquanto o projeto tem alterações
...
| Open project… | `⌘O` | um `.odproj` ou um `.mdproject` |
...
| Save project | `⌘S` | grava o `.odproj`; pede um local na primeira vez |
...
| Item | Atalho | O que faz |
| --- | --- | --- |
| OpenDIAL manual | `F1` | este manual, na primeira página |
| Help for this workspace | `⌘⇧?` | a página da área de trabalho em exibição |
| Keyboard shortcuts | | [[keyboard-shortcuts]] |
| Troubleshooting | | [[troubleshooting]] |
| About OpenDIAL | | a versão, a versão do MS-DIAL que acompanha, o runtime, a licença |
...
O bundle registra `.odproj`, `.mdproject`, `.oqproj`/`.opvproj` e os formatos brutos (`.mzML`,
