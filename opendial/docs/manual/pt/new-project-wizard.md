...
Um **Name** e uma **Folder**. O projeto é criado como `<Folder>/<Name>/<Name>.odproj`, com uma
...
O arquivo `.odproj` descrito em [[projects-and-files]]: o nome, o modo (LC-MS ou GC-MS), a pasta
