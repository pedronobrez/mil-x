...
| Shell: one window, one session, four workspaces switched with Ctrl/Cmd+1–4, menu bar, status bar, `•` for unsaved | Same shell. Workspaces: **Explorer**, **Analytics**, **Method**, **Samples**. |
