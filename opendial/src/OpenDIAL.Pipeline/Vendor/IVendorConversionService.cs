...
/// The real implementation lives in OpenDIAL.RawData (msconvert, native or Docker);
...
public sealed class DefaultVendorConversionService : IVendorConversionService
{
    ...
    public Task<string> EnsureMzmlAsync(string path, IProgress<string> log, CancellationToken ct)
    {
        ...
        throw new NotSupportedException(
            ...
            "Converting vendor data requires the msconvert bridge (OpenDIAL.RawData), which is not available in this build. " +
