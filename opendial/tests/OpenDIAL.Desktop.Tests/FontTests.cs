...
public class FontTests
{
    ...
    public void The_monospace_face_is_the_one_carried_with_the_application()
    {
        ...
        var narrow = WidthOf("avares://OpenDIAL/Assets/Fonts#JetBrains Mono NL", "iiiiiiiiii");
        var wide = WidthOf("avares://OpenDIAL/Assets/Fonts#JetBrains Mono NL", "MMMMMMMMMM");
