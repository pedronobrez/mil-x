---
title: BioPAN in MIL-X — design notes
...
`extension`, the twelve steps MIL-X adds for classes a run confirms and BioPAN does not cover,
...
one-sided p in the direction of the change, which MIL-X computes as the two-sided p's quantile
