...
section: Start
order: 1
summary: What MIL-X is, what this manual covers, and where to start reading.
---

# MIL-X manual

MIL-X is an open, cross-platform port of the **MS-DIAL 5** processing engine for untargeted
...
MS-DIAL's, used unchanged. What MIL-X adds around it is an open raw-data layer that reads mzML
...
- New to MIL-X: [[getting-started]], then [[concepts]].
