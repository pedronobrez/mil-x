---
title: O BioPAN no MIL-X — notas de projeto
...
# O BioPAN no MIL-X — notas de projeto
...
MIL-X acrescenta para classes que uma corrida confirma e o BioPAN não cobre, ligados por
...
do p unilateral na direção da mudança, que o MIL-X calcula como o quantil do p bilateral com o
