---
title: Manual do MIL-X
section: Start
order: 1
summary: O que é o MIL-X, o que este manual cobre, e por onde começar a ler.
---

# Manual do MIL-X

O MIL-X é um port aberto e multiplataforma do motor de processamento do **MS-DIAL 5** para
...
Windows. O motor é o do MS-DIAL, usado sem alteração. O que o MIL-X acrescenta à volta dele é
...
- Novo no MIL-X: [[getting-started]], depois [[concepts]].
