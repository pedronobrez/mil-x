...
A **Name** and a **Folder**. The project is created as `<Folder>/<Name>/<Name>.milx`, with a
...
The `.milx` file described in [[projects-and-files]]: the name, the mode (LC-MS or GC-MS), the
