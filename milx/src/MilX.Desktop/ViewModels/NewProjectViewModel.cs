...
public sealed partial class NewProjectViewModel : ViewModelBase
{
    ...
    public string ProjectPath => string.IsNullOrWhiteSpace(Name) ? string.Empty : Path.Combine(ProjectFolder, SafeName(Name) + MilXProject.Extension);
    ...
    public MilXProject? Result { get; private set; }

    private async Task<MilXProject> BuildProjectAsync()
    {
