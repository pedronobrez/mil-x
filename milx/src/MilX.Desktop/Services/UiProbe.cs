...
///
/// It is off unless MILX_UI_PROBE names a file, so the shipped application writes nothing.
///
...
public sealed class UiProbe
{
    ...
    public static UiProbe? FromEnvironment() =>
        Environment.GetEnvironmentVariable("MILX_UI_PROBE") is { Length: > 0 } path ? new UiProbe(path) : null;
        ...
        try
        {
            ...
            var snapshot = new Dictionary<string, object?>
            {
                ...
                ["review"] = new Dictionary<string, object?>
                {
                    ...
                    ["tagBothPolarities"] = analytics.TagBothPolarities,
