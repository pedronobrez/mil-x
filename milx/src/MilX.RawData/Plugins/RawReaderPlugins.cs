...
namespace MilX.RawData.Plugins;
...
/// "$MILX_PLUGINS" that contain implementations are loaded lazily on first use.
/// </summary>
...
public static class RawReaderPlugins
{
    ...
    private static IEnumerable<string> PluginDirectories() {
        var env = Environment.GetEnvironmentVariable("MILX_PLUGINS");
