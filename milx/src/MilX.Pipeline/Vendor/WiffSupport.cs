...
/// <summary>
/// Native SCIEX .wiff support through the MilX.Plugins.SciexWiff reader. Registers the plugin with
/// MilX.RawData (so <c>RawDataAccess</c> reads .wiff directly, no msconvert), expands multi-sample batches
